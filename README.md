...
Позже проект был частично портирован на Vue, где добавлена авторизация на JWT. Порт находится в другом [репозитории.](https://github.com/slappidyslap/pc-edu-helper-spring-vue)
