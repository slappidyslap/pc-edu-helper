...
[Пример работы фронтенда](https://slappidyslap.github.io/pc-edu-helper.html#client-example-video)
...
[Пример работы бэкенда](https://slappidyslap.github.io/pc-edu-helper.html#server-example-video)
